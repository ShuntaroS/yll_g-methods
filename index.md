...
- [Function
  reference](https://shuntaros.github.io/yll_g-methods/reference/index.html)
- [Getting
  started](https://shuntaros.github.io/yll_g-methods/articles/getting-started.html)
- [Generalized interventional
  effects](https://shuntaros.github.io/yll_g-methods/articles/interventional-effects.html)
...
See
[`vignette("getting-started", package = "YLLgmethods")`](https://shuntaros.github.io/yll_g-methods/articles/getting-started.md)
for a tour of the user-facing functions, and
...
for the identification framework behind stochastic and dynamic
interventions.
...
- [`estimate_yll_gformula_ate()`](https://shuntaros.github.io/yll_g-methods/reference/estimate_yll_gformula_estimand_wrappers.md)
  / `_att()` / `_atc()` — binary-exposure contrasts averaged over the
...
- [`estimate_yll_gformula_intervention()`](https://shuntaros.github.io/yll_g-methods/reference/estimate_yll_gformula_intervention.md)
  — generic interventional contrast accepting either fixed exposure
  values or a function `f(data)` returning subject-specific exposure
  probabilities.
- [`estimate_yll_gformula_binary_stochastic()`](https://shuntaros.github.io/yll_g-methods/reference/estimate_yll_gformula_binary_stochastic.md)
  ...
  — convenience wrappers for binary stochastic shifts, the latter using
  the natural exposure distribution as the reference.
...
- [`yll_make_binary_stochastic_intervention()`](https://shuntaros.github.io/yll_g-methods/reference/yll_make_binary_stochastic_intervention.md)
  — build an intervention function from
  `(P(A^*=\text{exposed}\mid A=\text{ref}), P(A^*=\text{exposed}\mid A=\text{exp}))`.
